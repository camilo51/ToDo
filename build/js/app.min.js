...
const formulario=document.querySelector(".formulario");const titulo=formulario.querySelector('#titulo');const categoria=document.querySelector('#categoria');const precio=formulario.querySelector('#precio');const agregar=formulario.querySelector('#agregar');const agregarContenedor=document.querySelector('.agregar-contenedor');const anuncios=document.querySelector('.anuncios');const botonAgregar=document.querySelector('#boton-agregar')
const botonEnviar=document.querySelector('#boton-enviar')
const lista=document.querySelector('#lista')
const gastoTotal=document.querySelector('#gasto-total');let errores=[];let getCategorias=JSON.parse(localStorage.getItem("categoria"))??[];let getGastos=JSON.parse(localStorage.getItem("gasto"))??[];let nuevaCategoria=getCategorias;let gastoContenedor=getGastos;let categoriaValida=false;window.addEventListener("load",function(){agregarSecciones()
agregarLista()
